...
func main() {
	...
	grpcServer := grpc.NewServer(grpc.ChainUnaryInterceptor(mw.LoggingInterceptor, mw.ValidateInterceptor, mw.RateLimiterInterceptor(limiter.New(memory.NewStore(), limiter.Rate{Period: 10 * time.Second, Limit: 2}))))
